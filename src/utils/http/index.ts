...
const apiPath = VITE_PROXY_DOMAIN || webConfigApi.apiPath
// 创建http实例
...
export const basePath = VITE_PROXY_DOMAIN || webConfigApi.apiPath
export const chatApiPath = VITE_CHAT_DOMAIN || webConfigApi.VITE_CHAT_DOMAIN
export const taskApiPath = VITE_TASK_DOMAIN || webConfigApi.VITE_TASK_DOMAIN
export const videoApiPath = VITE_VIDEO_DOMAIN || webConfigApi.apiPath
export const liveApiPath = VITE_VIDEO_DOMAIN || webConfigApi.apiPath
export const taskLiveApiPath = VITE_TASK_LIVE_DOMAIN || webConfigApi.VITE_TASK_LIVE_DOMAIN
export const audioConvertToolUrl = VITE_AUDIO_CONVERT_TOOL_DOMAIN || webConfigApi.VITE_AUDIO_CONVERT_TOOL_DOMAIN
