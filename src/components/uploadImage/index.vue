...
const handleSuccessOfAttachment = async (val, prefixPostfixFlag) => {
  ...
  const result = changeUploadDataWithCustom(raw.type, '', {}, props.uploadType)
...
const beforeUpload = (val: any) => {
  uploadDataHead.value = changeUploadDataWithCustom(val.type, '', {}, EUploadFrom.SITE_LOGO).uploadData
}
