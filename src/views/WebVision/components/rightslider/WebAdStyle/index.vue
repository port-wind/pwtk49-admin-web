  ...
  <div class="webAdStyle">
    ...
    <el-form label-width="auto" ref="ruleFormRef" :model="formData" :rules="Com_state.rules" class="lef">
      ...
      <el-form-item label="列数" prop="columns">
        <el-input-number v-model="formData.columns" :min="1" :max="10" />
      </el-form-item>

      <!-- 总数 -->
      <el-form-item label="总数" prop="total">
        <el-input-number v-model="formData.total" :min="1" :max="100" />
      </el-form-item>

      <el-form-item label="点击反馈" prop="gridAttr.clickable">
        <el-switch v-model="formData.gridAttr.clickable" />
      </el-form-item>
    </el-form>
...
const formData = reactive({
  ...
  columns: configParamJson.columns,
  total: configParamJson.total,
  gridAttr: configParamJson.gridAttr
})
