<template>
  <div class="graphicnavigationstyle">
    ...
    <!-- 提示 -->
    <p style="color: #969799; font-size: 12px; margin-top: 10px">拖动选中的导航可对其排序</p>
      ...
      <vuedraggable :list="datas.imageList" item-key="index" :forceFallback="false" :animation="200">
        <template #item="{ element }">
          <section class="imgList">
            ...
            <!-- 标题和链接 -->
            <div class="imgText">
              <el-input v-model="element.text" placeholder="请输入标题，也可不填"></el-input>
              <!-- 选择类型 -->
              <div class="select-type">
                <el-select style="width: 60%" v-model="element.linktype" placeholder="请选择跳转类型">
                  <el-option
    ...
    <!-- 上传图片 -->
    <el-button @click="showUpload('0')" class="uploadImg" type="primary" plain>点击添加导航</el-button>
    ...
    <el-form label-width="80px" :model="datas">
      ...
      <el-form-item class="lef" label="商品类型">
        <el-radio-group v-model="datas.navigationType">
          <el-radio style="margin-left: 35px" :value="index - 1" v-for="index in 2" :key="index">
            {{ index === 1 ? '图片导航' : '文字导航' }}
          </el-radio>
        </el-radio-group>
      </el-form-item>
      ...
      <el-form-item class="lef" label="背景图片">
        <div class="shop-head-pic" style="text-align: center">
          ...
          <div class="shop-head-pic-btn" style="text-align: center">
            <el-button @click="showUpload('1')" class="uploadImg" type="primary" plain>更换图片</el-button>
