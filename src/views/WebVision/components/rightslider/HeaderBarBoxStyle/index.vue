    ...
    <el-form label-width="auto" ref="ruleFormRef" :model="datas" :rules="rules" class="lef">
      ...
      <el-form-item label="主题" prop="theme">
        ...
        <el-form-item label="主要色" prop="primary">
          <el-color-picker
            v-model="datas.configParamJson.theme.primary"
            show-alpha
            class="picke"
        ...
        <el-form-item label="次要色" prop="secondary">
          <el-color-picker
            v-if="datas.configParamJson.theme.secondary"
            v-model="datas.configParamJson.theme.secondary"
            show-alpha
            class="picke"
            :predefine="predefineColors"
          ></el-color-picker>
        ...
        <el-form-item label="渐变方式" prop="gradient">
          <el-select v-model="datas.configParamJson.gradient" placeholder="请选择渐变方式">
      ...
      <el-form-item label="属性设置" prop="Attr">
        ...
        <el-form-item label="是否吸顶" prop="sticky">
          <el-switch v-model="datas.configParamJson.Attr.sticky" active-text="是" inactive-text="否"></el-switch>
        </el-form-item>

        <el-form-item label="吸顶偏移" prop="offsetTop">
          <el-input-number
            v-model="datas.configParamJson.Attr.offsetTop"
      ...
      <div class="form-container">
        <el-form-item label="背景色" prop="bgColor" class="lef">
          <!-- 颜色选择器 -->
          <el-color-picker
            v-model="datas.configParamJson.bgColor"
            show-alpha
            class="picke"
            :predefine="predefineColors"
          ></el-color-picker>
...
import type { HeaderBarBox } from '@/views/WebVision/components/componentsbiz/HeaderBarBox/type'
import type { ISetStyle } from '@/views/WebVision/components/componentsbiz/componentProperties/index'

defineComponent({
  name: 'HeaderBarBoxStyle'
})

interface IProps {
  datas: ISetStyle<HeaderBarBox>
}
// 定义 props
...
const handleMidUploadSuccess = (fileInfo) => {
  ...
  datas.configParamJson.middleSrc = path
}

const handleMidRemove = (file) => {
  middleImgList.value = middleImgList.value.filter((item) => item.uid !== file.uid)
  datas.configParamJson.middleSrc = ''
}

// const configParamJson =
//   typeof datas.configParamJson === 'string' ? JSON.parse(datas.configParamJson) : datas.configParamJson
...
const modelOptions = ref([{ label: '模式 1', value: 's1' }])
...
//     model: datas.configParamJson.model ?? 's1',
//     logoSrc: datas.configParamJson.logoSrc,
//     middleSrc: datas.configParamJson.middleSrc,
//     bgImg: datas.configParamJson.bgImg,
//     bgColor: datas.configParamJson.bgColor,
//     textColor: datas.configParamJson.textColor,
//     theme: {
//       primary: datas.configParamJson.theme?.primary,
//       secondary: datas.configParamJson.theme?.secondary,
//       gradient: datas.configParamJson.theme?.gradient
//     },
//     Attr: {
//       sticky: datas.configParamJson.Attr?.sticky,
//       offsetTop: datas.configParamJson.Attr?.offsetTop
//     }
//   })
// }
