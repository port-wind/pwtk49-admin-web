<template>
  <div class="storeinformationstyle">
    ...
    <p style="color: #969799; font-size: 12px">建议尺寸：750x370 像素，尺寸不匹配时，图片将被压缩或拉伸以铺满画面</p>
    ...
    <el-form label-width="80px" :model="datas" :rules="rules">
      ...
      <el-form-item label="店铺名称" class="lef" prop="name">
        <el-input v-model="datas.name" placeholder="请填写店铺名称" maxlength="20"></el-input>
      </el-form-item>

      <!-- 店铺名称 -->
      <el-form-item label="优惠信息" class="lef">
        <el-input v-model="datas.Discount" placeholder="请填写优惠信息也可不填" maxlength="45"></el-input>
      </el-form-item>
    </el-form>
