<template>
  <div class="InvestigateStyle">
    ...
    <el-form label-width="100px" :model="datas">
      ...
      <vuedraggable :list="datas.iconList" item-key="index" :forceFallback="false" :animation="200">
        <template #item="{ element, index }">
          <section class="imgBanner">
            ...
            <div>
              ...
              >
                <img class="imag" :src="replaceIconIndex == 1 ? element.iconPic : element.inactive" draggable="false" />
                <div>
