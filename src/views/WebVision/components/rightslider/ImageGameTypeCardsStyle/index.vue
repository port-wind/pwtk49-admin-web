<script setup lang="ts" name="ImageGameTypeCardsStyle">
...
import type { IDatas } from '@/views/WebVision/components/componentsbiz/ImageGameTypeCards/type'
...
<template>
  <div class="ImageGameTypeCardsStyle">
