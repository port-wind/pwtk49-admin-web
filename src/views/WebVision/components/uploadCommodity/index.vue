<template>
  <div class="uploadCommodity">
    ...
    >
      <!-- 选择类型 -->
      <el-select style="width: 60%" v-model="type" placeholder="请选择跳转类型" @change="selectType()">
      ...
      changeType(isVisible, linkType) {
        if (isVisible && linkType) {
          ...
          let res = {
            ...
            data: [
              {
                coverUrl: 'https://imgs.starfirelink.com/minicourse/非遗传承人@2x_1621504834414.png',
                introduce: '',
                price: 0,
                name: '测试1',
              ...
              {
                coverUrl: 'https://imgs.starfirelink.com/minicourse/QQ截图20210409170420_1621416051505.png',
                introduce: '1',
                price: 1,
                name: '测试2',
                videoId: '',
