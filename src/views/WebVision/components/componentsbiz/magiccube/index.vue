    ...
    <section class="buju buju4" v-show="datas.rubiksCubeType === 6 && showimageList">
      ...
      <div style="display: inline-flex; flex-direction: column; width: 100%">
        ...
        <div class="rubiksCubeType">
          <div
            class="hw"
            style="display: inline-flex; justify-content: center; align-items: center; padding-top: 150px"
            v-for="index in 2"
            :key="index"
          >
            <img
...
export default {
  ...
  computed: {
    showimageList() {
      // if (this.datas.rubiksCubeType === 0 && !this.datas.imageList[0].src && !this.datas.imageList[1].src) return false

      // if (
      //   (this.datas.rubiksCubeType === 1 || this.datas.rubiksCubeType === 4 || this.datas.rubiksCubeType === 5) &&
      ...
      // if (
      //   (this.datas.rubiksCubeType === 2 || this.datas.rubiksCubeType === 6 || this.datas.rubiksCubeType === 3) &&
      //   !this.datas.imageList[0].src &&
      //   !this.datas.imageList[1].src &&
      //   !this.datas.imageList[2].src &&
